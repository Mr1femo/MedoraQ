...
function setupSheet() {
  ...
  const headers = [
    ...
    "Existing Branding",
    "Content Approver",
    "Medical Practice USP",
    "Unique Product",
    "Brand & Product Stand (1-10)",
    "On-Camera Team Member",
    "Filming Participants Names",
    "Comfortable On Camera",
    "Filming Available Days",
    "Filming Locations",
    "Filming Location Other",
    "Filming Location Addresses",
    "Filming Not Permitted Areas",
    "Filming Safety Requirements",
    "Filming Restricted Dates",
    "Preferred Filming Hours",
    "Location Visit Before Filming",
    "Location Visit Date/Time",
    "Location Visit Accompaniment",
    "Locations Prepared Before Filming",
    "Products Available On Filming Day",
